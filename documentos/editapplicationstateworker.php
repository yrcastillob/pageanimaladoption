...
$sql = "SELECT * FROM estadosolicitud WHERE id_estado_solicitud ='$ideditar' AND id_trabajador='$id_trabajador'";
...
if (mysqli_num_rows($result1) > 0) {
    ...
    <div class="formcontainer_form">
            <form action="confirmeditstatusapplicationworker.php" method="post" class="form">
