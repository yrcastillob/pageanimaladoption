...
session_start();
$ideditar = $_POST['ideditar2'];
$nombreservicio = $_POST['title2'];
$descripcion = $_POST['description2'];
$imagen = $_POST['imagename2'];
$tipoanimal = $_POST['animalType2'];

$sql = "UPDATE servicios SET nombre_servicio = '$nombreservicio', descripcion_servicio = '$descripcion', url_img='$imagen', id_tipo_animal= '$tipoanimal' WHERE id_servicio = '$ideditar'";
