...
$trabajador = $_POST['worker'];
$estado = $_POST['estado'];
$comentario = $_POST['comentario'];

/* VARIABLE SQL CON LOS DATOS*/
$sql = "INSERT INTO estadosolicitud (estado, comentarios_estado_solicitud, id_solicitud, id_trabajador) VALUES ('$estado', '$comentario', '$id_solicitud', '$trabajador')" ;
