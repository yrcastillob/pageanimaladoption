...
$sql = "SELECT * FROM estadosolicitud WHERE id_estado_solicitud ='$idbuscar' AND id_trabajador='$id_trabajador'";
...
<div class="create-products">
    ...
    <div class="formcontainer_form">
    <form action="missolicitudes.php" method="post" class="form">
