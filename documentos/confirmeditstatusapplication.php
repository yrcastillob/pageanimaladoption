...
session_start();
$id_editar= $_POST['ideditar'];
$id_solicitud= $_POST['id_solicitud'];
$worker = $_POST['worker'];
$estado = $_POST['estado'];
$comentario = $_POST['comentario'];

$sql = "UPDATE estadosolicitud SET estado = '$estado', comentarios_estado_solicitud = '$comentario', id_solicitud ='$id_solicitud', id_trabajador = '$worker' WHERE id_estado_solicitud = '$id_editar'";
...
if ($conn->query($sql) === TRUE){
   header("Location: manageapplicationstate.php");
    ...
    echo '
            ...
            <script>
        setTimeout(function() {
            window.location.href = "manageapplicationstate.php";
        }, 3000); 
      </script>
