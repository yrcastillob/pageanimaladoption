...
$sql = "UPDATE estadosolicitud SET estado = '$estado', comentarios_estado_solicitud = '$comentario', id_solicitud ='$id_solicitud', id_trabajador = '$id_trabajador' WHERE id_estado_solicitud = '$id_editar'";
