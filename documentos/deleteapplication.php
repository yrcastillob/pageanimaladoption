...
$sql = "DELETE FROM solicitudes WHERE id_solicitud ='$ideliminar'";


if ($conn->query($sql) === TRUE){
    $sql2 = "DELETE FROM estadosolicitud WHERE id_solicitud ='$ideliminar'";
    ...
    if ($conn->query($sql2) === TRUE) {
        ...
        echo '
            ...
            <h1>Ocurrió un error al eliminar la solicitud</h1>
